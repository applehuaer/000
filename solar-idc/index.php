...
<div id="main">
	...
	<div id="main-up">
	  	<div class="main-up-left"><a href="#"><img src="./tpl/image/m-logo.png" alt="动态图片" width="660px" height="303px;" /></a></div>
			
	  	<div class="main-up-right" style="background-image:url(./tpl/image/bg1.jpg)">
			<div class="main-up-right-a">
				<ul>
					<li> <h2><img src="./tpl/image/01-t.jpg" alt="12联保技术"   /></h2></li>
					<li><img src="./tpl/image/12-1.jpg" alt="每个计算节点（云主机）均有12个节点相互备份，永不停机。"  /></li>		
				</ul>
			</div>
			
			<div class="main-up-right-a">
				<ul>
					<li><h2  style="padding-bottom:2px;"><img src="./tpl/image/02-t.jpg" alt="几何级提升性价比" width="145px" height="17px" /></h2></li>
					<li><img src="./tpl/image/02-word.jpg" alt="微服云主机十分适合大规模和超大规模的互联网应用：门户网站、即时通讯、视频网站、电子商城、网络游戏、虚拟社区等，规模越大，性价比优势越大!"  /></li>
			...
			<div class="main-up-right-a">
				<ul>
					<li> <h2><img src="./tpl/image/03-t.jpg" alt="超强兼容" /></h2></li>
					<li> <img src="./tpl/image/03-word.jpg" alt="兼容连接所有磁盘阵列服务器，数据库服务器." /></li>
					<p style=" text-align:right; padding-right:30px"><a href="#"><img src="./tpl/image/more.jpg" alt="更多" /></a></p>			</ul>
			</div>
	...
	<div id="mian-down">
	  	<div id="mian-down-l" class="border-rt" style="background-image:url(./tpl/image/bg2.jpg)">
			...
			<p style="margin:0; padding:12px 0 10px 30px;;"><img src="./tpl/image/enter demain.jpg" alt="域名申请入口" /></p>
			<p style=" margin:0; padding:5px 0px 0px 0px"><a target="_blank" href="http://domain.solar-idc.cn/"><img src="./tpl/image/details.jpg" alt="详细信息" /></a></p>
			
		</div>
		
		<div class="mian-down-l-friendlink border-rt" style="background-image:url(./tpl/image/friendlink.jpg)">
		...
		<div id="mian-down-m" class="border-rt"  style="background-image:url(./tpl/image/bg3.jpg)">
			...
			<div class="mian-down-m-1">
				<ul>
					...
					<li><div class="mian-down-m-word"><img src="./tpl/image/m-d-word2.jpg" alt="我们拥有国家高级别电信级数据机房，为中国联通提供高品质技术支持" /></div></li>
				</ul>
				
				<p style="padding-top:3px; padding-right:8px;">&nbsp;</p>
				<p style="margin:3px; "><img src="./tpl/image/circle1.jpg" width="315px" /></p>
			</div> <!-- mian-down-m-1-->
			
			
			<div class="mian-down-m-2">
				<ul>
					<li ><img src="./tpl/image/main-zhuji.jpg" /></li>
					<li><div class="mian-down-m-word1"><img src="./tpl/image/m-d-word3.jpg" alt="为客户自行架设的服务器提供机柜，客户可享有高速稳定的独立光钎网络，宽带高达1000MB." /></div></li>
				</ul>
				
				<p>&nbsp;</p>
				<p style="margin:3px;"><img src="./tpl/image/circle1.jpg"  width="350px" /></p>
			</div><!--mian-down-m-2-->
			
			<div class="mian-down-m-2">
				<ul>
					<li ><img src="./tpl/image/main-sun.jpg"   /></li>
